...
"""
g_root_dirname = "../datasets/rfml/train"
g_n_classes = len(os.listdir(g_root_dirname))
print(f">> g_n_classes : {g_n_classes}")
g_batch_size = 5
"""
g_img_size = 64
...
class ContextUnet(nn.Module):
    def __init__(self, in_channels, n_feat=256, n_classes=42):
...
class DDPM(nn.Module):
    ...
    def sample(self, n_sample, size, device, guide_w=0.0, n_c=42):
